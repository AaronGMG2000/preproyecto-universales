...
class AddAdministratorPage extends StatefulWidget {
  ...
  @override
  AddAdministratorPageState createState() => AddAdministratorPageState();
}

class AddAdministratorPageState extends State<AddAdministratorPage> {
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          late List<User> administrators =
              chanel.administradores.values.toList();
