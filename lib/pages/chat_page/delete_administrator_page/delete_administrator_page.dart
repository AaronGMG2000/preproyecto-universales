...
class DeleteAdministratorPage extends StatefulWidget {
  final User user;
  final Chanel chanel;
  const DeleteAdministratorPage({
    Key? key,
    required this.user,
  ...
  @override
  DeleteAdministratorPageState createState() => DeleteAdministratorPageState();
}

class DeleteAdministratorPageState extends State<DeleteAdministratorPage> {
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          users = chanel.administradores.values.toList();
