...
class ViewAdministratorPage extends StatefulWidget {
  final User user;
  final Chanel chanel;
  const ViewAdministratorPage({
    Key? key,
    required this.user,
  ...
  @override
  ViewAdministratorPageState createState() => ViewAdministratorPageState();
}

class ViewAdministratorPageState extends State<ViewAdministratorPage> {
